    ...
    const fetchStats = async () => {
      try {
        ...
        const mapped = [
          ...
          { icon: Users, label: 'Talabalar', value: data.total_users + 100, color: 'text-secondary' },
        ];
  ...
  return (
    <section id="home" className="relative min-h-screen pt-16 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1200 120" className="w-full h-auto text-background" style={{ transform: 'scaleY(0.7)', transformOrigin: 'bottom' }}>
